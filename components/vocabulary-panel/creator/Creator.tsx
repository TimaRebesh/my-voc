...
export const Creator = ({
  ...
  const [isShared, setIsShared] = useState<IVocabulary[VocabularyFields.IS_SHARED]>(false);
  const [description, setDescription] = useState<IVocabulary[VocabularyFields.DESCRIPTION]>('');
