...
export function WritingView({ studyWord, onChange, isHint, config }: WritingViewProps) {
  ...
  return <>
    <StudyingWord mode={RepeatedConst.TRANSLATED} studyWord={studyWord} config={config} />
    ...
    <Hint isHint={isHint} studyWord={studyWord} value={value} setValue={useHint} />
    <div className='w-40'>
      <Button
        className='w-full'
